...
- ⚡ **高温保护** — 电池≥50°C 持续 15 分钟后自动杀 AP 后端和碧蓝航线进程
...
- **电池**：电量百分比（数字动画过渡），电池温度（>40°C 预警，≥50°C 持续 15 分钟后杀 AP 和碧蓝航线）
...
- **CPU**：快速采集（CPU+网络+频率+内存+进程+AP进程）约 20% 单核，其他通道均 <1%
